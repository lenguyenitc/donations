            ...
            for($i=1;$i<=$columns;$i++){ ?>
                ...
                ?>
                    <div class="<?php echo esc_attr($item_class);?>">
                        <div class="zo-fancy-box-boxright">
                          <?php if($title):?>
                          <div class="zo-fancy-box-content-title clearfix">
                          <?php if($image_url):?>
                          <div class="zo-fancy-box-image left">
                              <img src="<?php echo esc_attr($image_url);?>" alt="" />
                          </div>
                          <?php else:?>
                          <div class="zo-fancy-box-content-icon left">
                          ...
                          <?php endif;?>
                              <<?php echo esc_attr($zo_title_size); ?> class="zo-fancy-box-title left" style="color: <?php echo esc_attr($zo_fancybox_title_color); ?>;">
...
<style type="text/css">
  .<?php echo esc_attr($class_link); ?>.zo-fancybox-layout-3 .zo-fancyboxes-readmore a:hover {
