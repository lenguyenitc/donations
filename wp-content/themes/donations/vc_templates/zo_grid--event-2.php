<div class="zo-grid-wraper zo-news-layout2 <?php echo esc_attr($atts['template']); ?>"
            ...
            while ($posts->have_posts()) {
                ...
                if ($i == 0) :
                    ...
                    <div class="<?php echo esc_attr($class_first_item); ?>">
                        <?php get_template_part('single-templates/events/content', 'teaser') ?>
                    </div>
                <?php
                endif;
                $i++;
                ...
                while ($posts->have_posts()) {
                    ...
                    ?>
                        <div class="<?php echo esc_attr($atts['item_class']); ?>">
                            <?php get_template_part('single-templates/events/content', 'thumbnail') ?>
                        </div>
                    <?php
                    endif;
                    $i++;
