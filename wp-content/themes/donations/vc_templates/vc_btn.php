...
if ( $use_link ):
	...
	?>
	<button    class="vc_general vc_btn3 <?php echo esc_attr( $button_type ); ?> <?php echo esc_attr( $button_class ); ?>"<?php echo do_shortcode($inline_css); ?>><?php echo do_shortcode($button_html); ?></button><?php
