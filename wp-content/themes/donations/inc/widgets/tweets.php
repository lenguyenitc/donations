...
class ZO_Tweets_Widget extends WP_Widget {
    ...
    function ZO_Tweets_Widget()
    {
        ...
        $control_ops = array('id_base' => 'zo-tweets-widget');

        parent::__construct('zo-tweets-widget', __('ZO Twitter',THEMENAME), $widget_ops, $control_ops);
    }
    ...
    function form($instance)
    {
        ...
        <p>
            ...
            <select id="<?php echo esc_attr($this->get_field_id('show_avatar')); ?>" class="widefat" name="<?php echo esc_attr($this->get_field_name('show_avatar')); ?>">
                <option value="no" <?php if($instance['show_avatar'] == 'no'){ echo "selected='selected'"; } ?>><?php echo __('No',THEMENAME); ?></option>
                <option value="yes" <?php if($instance['show_avatar'] == 'yes'){ echo "selected='selected'"; } ?>><?php echo __('Yes',THEMENAME); ?></option>
            </select>
        </p>
        <p>
