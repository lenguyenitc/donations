        ...
        <div class="widget_cart_search_wrap">
            <div class="header">
                ...
                <a href="javascript:void(0)" class="icon_cart_wrap" data-display=".shopping_cart_dropdown" data-no_display=".widget_searchform_content"><i class="fa fa-shopping-cart cart-icon"></i><span class="cart_total"><?php
					echo do_shortcode($woocommerce?' '.$woocommerce->cart->get_cart_contents_count():'');?></span></a>
				<?php endif; ?>
				<?php if($show_search):?>
            ...
            <div class="shopping_cart_dropdown">
                        ...
                        <?php if ( !$cart_is_empty ) : ?>
                            ...
                            <?php foreach ( $woocommerce->cart->get_cart() as $cart_item_key => $cart_item ) :
                                ...
                                <li class="cart-list clearfix">
                                    ...
                                    <?php echo do_shortcode($woocommerce->cart->get_item_data( $cart_item )); ?>
                ...
                <a href="<?php echo esc_url($woocommerce->cart->get_cart_url()); ?>" class="btn btn-primary left wc-forward"><?php _e( 'Cart', 'woocommerce' ); ?></a>
                <span class="total right"><?php _e( 'Total', 'woocommerce' ); ?>:<span><?php echo do_shortcode($woocommerce->cart->get_cart_subtotal()); ?></span></span>
...
if(!function_exists('woocommerce_header_add_to_cart_content')){
    ...
    <div class="shopping_cart_dropdown">
        ...
        <?php if ( sizeof( $woocommerce->cart->get_cart() ) <= 0 ) : ?>
        <?php endif; ?>
        <a href="<?php echo do_shortcode($woocommerce->cart->get_cart_url()); ?>" class="btn btn-primary left wc-forward"><?php _e( 'Cart', 'woocommerce' ); ?></a>
        <span class="total right"><?php _e( 'Total', 'woocommerce' ); ?>:<span><?php echo do_shortcode($woocommerce->cart->get_cart_subtotal()); ?></span></span>
        <?php if ( sizeof( $woocommerce->cart->get_cart() ) <= 0 ) : ?>
