                        ...
                        if ( class_exists( 'Redux_VendorURL' ) ) {
                            ...
                            if ( ! self::is_enqueued( $handle, 'enqueued', $is_script ) ) {
                                ...
                                if ( self::$_parent->args['dev_mode'] ) {
                                    $msg = sprintf( wp_kses(esc_html__(  'If you are developing offline, please download and install the <a href="%s" target="_blank">Redux Vendor Support</a> plugin/extension to bypass the our CDN and avoid this warning', 'redux-framework' ), $allowed_html), 'https://github.com/reduxframework/redux-vendor-support' );
                                }
