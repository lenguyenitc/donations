<div class="wrap about-wrap">
    ...
    <div id="redux-message" class="updated">
        ...
        <p class="submit">
            <a class="button-primary" href="<?php echo esc_url('reduxframework.com','http');?>"
                ...
                <div>
                    ...
                    <p>This version the fastest Redux ever released. We've integrated ajax_saving as well as many other
                        speed improvements to make Redux even surpass the load time of <a
                            href="<?php echo esc_url('github.com/syamilmj/Options-Framework','https');?>" target="_blank">SMOF</a> even with
                        large panels.</p>
                </div>
                <div>
                    ...
                    <p>We've gone back to the drawing boards and made Redux the <strong>simplest</strong> framework to
                        ...
                        having to define a class! <a href="<?php echo esc_url('docs.reduxframework.com/core/redux-api/','http');?>" target="_blank">Learn More</a></p>
                </div>
                <div class="last-feature">
                    <h4>Security Improvments</h4>

                    <p>Thanks to the help of <a href="<?php echo esc_url('www.pritect.net/','http');?>" target="_blank">James Golovich
            ...
            <div class="feature-section col three-col">
                <div>
                    ...
                    <p>Now developers can easily customize the Redux panel by declaring a templates location path. We've
                        also made use of template versioning so if we change anything, you will know. <br /><a href="<?php echo esc_url('docs.reduxframework.com/core/templates/','http');?>" target="_blank">Learn More</a></p>
                </div>
                <div>
