...
<div class="wrap about-wrap redux-status">
    ...
    <table class="redux_status_table widefat" cellspacing="0" id="status">
        ...
        <tr>
            ...
            <td class="help"><?php echo '<a href="#" class="redux-hint-qtip" qtip-content="' . esc_html__(  'The URL of your site\'s homepage.', 'redux-framework' ) . '">[?]</a>'; ?></td>
            <td><?php echo $sysinfo['home_url']; ?></td>
        </tr>
        <tr>
            <td data-export-label="Site URL"><?php esc_html_e( 'Site URL', 'redux-framework' ); ?>:</td>
            <td class="help"><?php echo '<a href="#" class="redux-hint-qtip" qtip-content="' . esc_html__(  'The root URL of your site.', 'redux-framework' ) . '">[?]</a>'; ?></td>
            <td><?php echo $sysinfo['site_url']; ?></td>
        </tr>
        <tr>
            <td data-export-label="Redux Version"><?php esc_html_e( 'Redux Version', 'redux-framework' ); ?>:</td>
            <td class="help"><?php echo '<a href="#" class="redux-hint-qtip" qtip-content="' . esc_html__(  'The version of Redux Framework installed on your site.', 'redux-framework' ) . '">[?]</a>'; ?></td>
        ...
        <tr>
            ...
            <td class="help"><?php echo '<a href="#" class="redux-hint-qtip" qtip-content="' . esc_html__(  'Redux and its extensions write data to the <code>uploads</code> directory. This directory must be writable.', 'redux-framework' ) . '">[?]</a>'; ?></td>
            <td><?php 
        ...
        <tr>
            ...
            <td class="help"><?php echo '<a href="#" class="redux-hint-qtip" qtip-content="' . esc_html__(  'The location of Wordpress\'s content URL.', 'redux-framework' ) . '">[?]</a>'; ?></td>
            <td><?php
        ...
        <tr>
            ...
            <td class="help"><?php echo '<a href="#" class="redux-hint-qtip" qtip-content="' . esc_html__(  'The version of WordPress installed on your site.', 'redux-framework' ) . '">[?]</a>'; ?></td>
            <td><?php bloginfo( 'version' ); ?></td>
        </tr>
        <tr>
            <td data-export-label="WP Multisite"><?php esc_html_e( 'WP Multisite', 'redux-framework' ); ?>:</td>
            <td class="help"><?php echo '<a href="#" class="redux-hint-qtip" qtip-content="' . esc_html__(  'Whether or not you have WordPress Multisite enabled.', 'redux-framework' ) . '">[?]</a>'; ?></td>
        ...
        <tr>
            ...
            <td class="help"><?php echo '<a href="#" class="redux-hint-qtip" qtip-content="' . esc_html__(  'The current permalink structure as defined in Wordpress Settings->Permalinks.', 'redux-framework' ) . '">[?]</a>'; ?></td>
        ...
        <tr>
            ...
            <td class="help"><?php echo '<a href="#" class="redux-hint-qtip" qtip-content="' . esc_html__(  'The current Reading mode of Wordpress.', 'redux-framework' ) . '">[?]</a>'; ?></td>
            <td><?php echo $sof; ?></td>
        </tr>
        ...
        <?php
            if ( $sof == 'page' ) {
                ...
                <tr>
                    ...
                    <td class="help"><?php echo '<a href="#" class="redux-hint-qtip" qtip-content="' . esc_html__(  'The currently selected page which acts as the site\'s Front Page.', 'redux-framework' ) . '">[?]</a>'; ?></td>
                    <td><?php echo $sysinfo['front_page']; ?></td>
                </tr>
                <tr>
                    <td data-export-label="Posts Page"><?php esc_html_e( 'Posts Page', 'redux-framework' ); ?>:</td>
                    <td class="help"><?php echo '<a href="#" class="redux-hint-qtip" qtip-content="' . esc_html__(  'The currently selected page in where blog posts are displayed.', 'redux-framework' ) . '">[?]</a>'; ?></td>
        ...
        <tr>
            ...
            <td class="help"><?php echo '<a href="#" class="redux-hint-qtip" qtip-content="' . esc_html__(  'The maximum amount of memory (RAM) that your site can use at one time.', 'redux-framework' ) . '">[?]</a>'; ?></td>
            <td><?php
        ...
        <tr>
            ...
            <td class="help"><?php echo '<a href="#" class="redux-hint-qtip" qtip-content="' . esc_html__(  'The prefix structure of the current Wordpress database.', 'redux-framework' ) . '">[?]</a>'; ?></td>
            <td><?php echo $sysinfo['db_table_prefix']; ?></td>
        </tr>
        <tr>
            <td data-export-label="WP Debug Mode"><?php esc_html_e( 'WP Debug Mode', 'redux-framework' ); ?>:</td>
            <td class="help"><?php echo '<a href="#" class="redux-hint-qtip" qtip-content="' . esc_html__(  'Displays whether or not WordPress is in Debug Mode.', 'redux-framework' ) . '">[?]</a>'; ?></td>
        ...
        <tr>
            ...
            <td class="help"><?php echo '<a href="#" class="redux-hint-qtip" qtip-content="' . esc_html__(  'The current language used by WordPress. Default = English', 'redux-framework' ) . '">[?]</a>'; ?></td>
    ...
    <table class="redux_status_table widefat" cellspacing="0" id="status">
        ...
        <tr>
            ...
            <td class="help"><?php echo '<a href="#" class="redux-hint-qtip" qtip-content="' . esc_html__(  'Information about web browser current in use.', 'redux-framework' ) . '">[?]</a>'; ?></td>
            <td><?php
    ...
    <table class="redux_status_table widefat" cellspacing="0" id="status">
        ...
        <tr>
            ...
            <td class="help"><?php echo '<a href="#" class="redux-hint-qtip" qtip-content="' . esc_html__(  'Information about the web server that is currently hosting your site.', 'redux-framework' ) . '">[?]</a>'; ?></td>
        ...
        <tr>
            ...
            <td class="help"><?php echo '<a href="#" class="redux-hint-qtip" qtip-content="' . esc_html__(  'Is the server running in a localhost environment.', 'redux-framework' ) . '">[?]</a>'; ?></td>
            <td><?php
        ...
        <tr>
            ...
            <td class="help"><?php echo '<a href="#" class="redux-hint-qtip" qtip-content="' . esc_html__(  'The version of PHP installed on your hosting server.', 'redux-framework' ) . '">[?]</a>'; ?></td>
            <td><?php echo $sysinfo['php_ver']; ?></td>
        </tr>
        <tr>
            <td data-export-label="ABSPATH"><?php esc_html_e( 'ABSPATH', 'redux-framework' ); ?>:</td>
            <td class="help"><?php echo '<a href="#" class="redux-hint-qtip" qtip-content="' . esc_html__(  'The ABSPATH variable on the server.', 'redux-framework' ) . '">[?]</a>'; ?></td>
        ...
        <?php if ( function_exists( 'ini_get' ) ) { ?>
            <tr>
                ...
                <td class="help"><?php echo '<a href="#" class="redux-hint-qtip" qtip-content="' . esc_html__(  'The largest filesize that can be contained in one post.', 'redux-framework' ) . '">[?]</a>'; ?></td>
            ...
            <tr>
                ...
                <td class="help"><?php echo '<a href="#" class="redux-hint-qtip" qtip-content="' . esc_html__(  'The amount of time (in seconds) that your site will spend on a single operation before timing out (to avoid server lockups)', 'redux-framework' ) . '">[?]</a>'; ?></td>
            ...
            <tr>
                ...
                <td class="help"><?php echo '<a href="#" class="redux-hint-qtip" qtip-content="' . esc_html__(  'The maximum number of variables your server can use for a single function to avoid overloads.', 'redux-framework' ) . '">[?]</a>'; ?></td>
            ...
            <tr>
                ...
                <td class="help"><?php echo '<a href="#" class="redux-hint-qtip" qtip-content="' . esc_html__(  'Determines if PHP will display errors within the browser.', 'redux-framework' ) . '">[?]</a>'; ?></td>
                <td><?php
        ...
        <tr>
            ...
            <td class="help"><?php echo '<a href="#" class="redux-hint-qtip" qtip-content="' . esc_html__(  'The version of MySQL installed on your hosting server.', 'redux-framework' ) . '">[?]</a>'; ?></td>
            <td><?php echo $sysinfo['mysql_ver']; ?></td>
        </tr>
        <tr>
            <td data-export-label="Max Upload Size"><?php esc_html_e( 'Max Upload Size', 'redux-framework' ); ?>:</td>
            <td class="help"><?php echo '<a href="#" class="redux-hint-qtip" qtip-content="' . esc_html__(  'The largest filesize that can be uploaded to your WordPress installation.', 'redux-framework' ) . '">[?]</a>'; ?></td>
        ...
        <tr>
            ...
            <td class="help"><?php echo '<a href="#" class="redux-hint-qtip" qtip-content="' . esc_html__(  'The default timezone for your server.', 'redux-framework' ) . '">[?]</a>'; ?></td>
            <td><?php
        ...
        <?php
            ...
            $posting['fsockopen_curl']['help'] = '<a href="#" class="redux-hint-qtip" qtip-content="' . esc_html__(  'Used when communicating with remote services with PHP.', 'redux-framework' ) . '">[?]</a>';
            ...
            $posting['soap_client']['help'] = '<a href="#" class="redux-hint-qtip" qtip-content="' . esc_html__(  'Some webservices like shipping use SOAP to get information from remote servers, for example, live shipping quotes from FedEx require SOAP to be installed.', 'redux-framework' ) . '">[?]</a>';
            ...
            $posting['dom_document']['help'] = '<a href="#" class="redux-hint-qtip" qtip-content="' . esc_html__(  'HTML/Multipart emails use DOMDocument to generate inline CSS in templates.', 'redux-framework' ) . '">[?]</a>';
            ...
            */
            ...
            //$posting['gzip']['help'] = '<a href="#" class="redux-hint-qtip" qtip-content="' . esc_html__(  'GZip (gzopen) is used to open the GEOIP database from MaxMind.', 'redux-framework' ) . '">[?]</a>';
            //
            ...
            $posting['wp_remote_post']['help'] = '<a href="#" class="redux-hint-qtip" qtip-content="' . esc_html__(  'Used to send data to remote servers.', 'redux-framework' ) . '">[?]</a>';
            ...
            $posting['wp_remote_get']['help'] = '<a href="#" class="redux-hint-qtip" qtip-content="' . esc_html__(  'Used to grab information from remote servers for updates updates.', 'redux-framework' ) . '">[?]</a>';
            ...
            foreach ( $sysinfo['redux_instances'] as $inst => $data ) {
                ...
                <table class="redux_status_table widefat" cellspacing="0" id="status">
                    ...
                    <tr>
                        ...
                        <td class="help"><?php echo '<a href="#" class="redux-hint-qtip" qtip-content="' . esc_html__(  'The opt_name argument for this instance of Redux.', 'redux-framework' ) . '">[?]</a>'; ?></td>
                    ...
                    <?php
                        if ( isset( $args['global_variable'] ) && $args['global_variable'] != '' ) {
                            ...
                            <tr>
                                ...
                                <td class="help"><?php echo '<a href="#" class="redux-hint-qtip" qtip-content="' . esc_html__(  'The global_variable argument for this instance of Redux.', 'redux-framework' ) . '">[?]</a>'; ?></td>
                    ...
                    <tr>
                        ...
                        <td class="help"><?php echo '<a href="#" class="redux-hint-qtip" qtip-content="' . esc_html__(  'Indicates if developer mode is enabled for this instance of Redux.', 'redux-framework' ) . '">[?]</a>'; ?></td>
                    ...
                    <tr>
                        ...
                        <td class="help"><?php echo '<a href="#" class="redux-hint-qtip" qtip-content="' . esc_html__(  'Indicates if ajax based saving is enabled for this instance of Redux.', 'redux-framework' ) . '">[?]</a>'; ?></td>
                    ...
                    <tr>
                        ...
                        <td class="help"><?php echo '<a href="#" class="redux-hint-qtip" qtip-content="' . esc_html__(  'The page slug denotes the string used for the options panel page for this instance of Redux.', 'redux-framework' ) . '">[?]</a>'; ?></td>
                        <td><?php echo $args['page_slug']; ?></td>
                    </tr>
                    <tr>
                        <td data-export-label="page_permissions">page_permissions:</td>
                        <td class="help"><?php echo '<a href="#" class="redux-hint-qtip" qtip-content="' . esc_html__(  'The page permissions variable sets the permission level required to access the options panel for this instance of Redux.', 'redux-framework' ) . '">[?]</a>'; ?></td>
                        <td><?php echo $args['page_permissions']; ?></td>
                    </tr>
                    <tr>
                        <td data-export-label="menu_type">menu_type:</td>
                        <td class="help"><?php echo '<a href="#" class="redux-hint-qtip" qtip-content="' . esc_html__(  'This variable set whether or not the menu is displayed as an admin menu item for this instance of Redux.', 'redux-framework' ) . '">[?]</a>'; ?></td>
                        <td><?php echo $args['menu_type']; ?></td>
                    </tr>
                    <tr>
                        <td data-export-label="page_parent">page_parent:</td>
                        <td class="help"><?php echo '<a href="#" class="redux-hint-qtip" qtip-content="' . esc_html__(  'The page parent variable sets where the options menu will be placed on the WordPress admin sidebar for this instance of Redux.', 'redux-framework' ) . '">[?]</a>'; ?></td>
                        <td><?php echo $args['page_parent']; ?></td>
                    </tr>

                    <tr>
                        <td data-export-label="compiler">compiler:</td>
                        <td class="help"><?php echo '<a href="#" class="redux-hint-qtip" qtip-content="' . esc_html__(  'Indicates if the compiler flag is enabled for this instance of Redux.', 'redux-framework' ) . '">[?]</a>'; ?></td>
                        <td><?php echo true == $args['compiler'] ? '<mark class="yes">' . '&#10004;' . '</mark>' : '<mark class="no">' . '&ndash;' . '</mark>'; ?></td>
                    </tr>
                    <tr>
                        <td data-export-label="output">output:</td>
                        <td class="help"><?php echo '<a href="#" class="redux-hint-qtip" qtip-content="' . esc_html__(  'Indicates if output flag for globally shutting off all CSS output is enabled for this instance of Redux.', 'redux-framework' ) . '">[?]</a>'; ?></td>
                    ...
                    <tr>
                        ...
                        <td class="help"><?php echo '<a href="#" class="redux-hint-qtip" qtip-content="' . esc_html__(  'The output_tag variable sets whether or not dynamic CSS will be generated for the customizer and Google fonts for this instance of Redux.', 'redux-framework' ) . '">[?]</a>'; ?></td>
                    ...
                    <?php
                        if ( isset( $args['templates_path'] ) && $args['templates_path'] != '' ) {
                            ...
                            <tr>
                                ...
                                <td class="help"><?php echo '<a href="#" class="redux-hint-qtip" qtip-content="' . esc_html__(  'The specified template path containing custom template files for this instance of Redux.', 'redux-framework' ) . '">[?]</a>'; ?></td>
                                <td><?php echo '<code>' . $args['templates_path'] . '</code>'; ?></td>
                            </tr>
                            <tr>
                                <td data-export-label="Templates">Templates:</td>
                                <td class="help"><?php echo '<a href="#" class="redux-hint-qtip" qtip-content="' . esc_html__(  'List of template files overriding the default Redux template files.', 'redux-framework' ) . '">[?]</a>'; ?></td>
                                <?php
                        ...
                        if ( ! empty( $ext ) && is_array( $ext ) ) {
                            ...
                            <tr>
                                ...
                                <td class="help"><?php echo '<a href="#" class="redux-hint-qtip" qtip-content="' . esc_html__(  'Indicates the installed Redux extensions and their version numbers.', 'redux-framework' ) . '">[?]</a>'; ?></td>
                                <td>
                                    <?php
    ...
    <table class="redux_status_table widefat" cellspacing="0" id="status">
        ...
        <tr>
            ...
            <td class="help"><?php echo '<a href="#" class="redux-hint-qtip" qtip-content="' . esc_html__(  'The name of the current active theme.', 'redux-framework' ) . '">[?]</a>'; ?></td>
            <td><?php echo $sysinfo['theme']['name']; ?></td>
        </tr>
        <tr>
            <td data-export-label="Version"><?php esc_html_e( 'Version', 'redux-framework' ); ?>:</td>
            <td class="help"><?php echo '<a href="#" class="redux-hint-qtip" qtip-content="' . esc_html__(  'The installed version of the current active theme.', 'redux-framework' ) . '">[?]</a>'; ?></td>
            <td><?php
        ...
        <tr>
            ...
            <td class="help"><?php echo '<a href="#" class="redux-hint-qtip" qtip-content="' . esc_html__(  'The theme developers URL.', 'redux-framework' ) . '">[?]</a>'; ?></td>
            <td><?php echo $sysinfo['theme']['author_uri']; ?></td>
        </tr>
        <tr>
            <td data-export-label="Child Theme"><?php esc_html_e( 'Child Theme', 'redux-framework' ); ?>:</td>
            <td class="help"><?php echo '<a href="#" class="redux-hint-qtip" qtip-content="' . esc_html__(  'Displays whether or not the current theme is a child theme.', 'redux-framework' ) . '">[?]</a>'; ?></td>
            <td><?php
        ...
        <?php
            ...
            if ( is_child_theme() ) {
                ...
                <tr>
                    ...
                    <td class="help"><?php echo '<a href="#" class="redux-hint-qtip" qtip-content="' . esc_html__(  'The name of the parent theme.', 'redux-framework' ) . '">[?]</a>'; ?></td>
                ...
                <tr>
                    ...
                    <td class="help"><?php echo '<a href="#" class="redux-hint-qtip" qtip-content="' . esc_html__(  'The installed version of the parent theme.', 'redux-framework' ) . '">[?]</a>'; ?></td>
                ...
                <tr>
                    ...
                    <td class="help"><?php echo '<a href="#" class="redux-hint-qtip" qtip-content="' . esc_html__(  'The parent theme developers URL.', 'redux-framework' ) . '">[?]</a>'; ?></td>
