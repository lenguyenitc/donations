    ...
    class Redux_Welcome {
        ...
        public function actions() {
            ...
            <p class="redux-actions">
                <a href="<?php echo esc_url('docs.reduxframework.com/','http');?>" class="docs button button-primary">Docs</a>
                <a href="<?php echo esc_url('wordpress.org/plugins/redux-framework/','http');?>" class="review-us button button-primary"
                    target="_blank">Review Us</a>
                <a href="<?php echo esc_url('www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=MMFMHWUPKHKPW','https');?>"
                    class="review-us button button-primary" target="_blank">Donate</a>
                <a href="<?php echo esc_url('twitter.com/share','https');?>" class="twitter-share-button" data-url="http://reduxframework.com"
