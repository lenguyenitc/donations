...
class ZoCoreControl
{
        ...
        <div class="images-field clearfix">
            ...
            foreach ($selected as $value):
                ...
                <li class="items" data-id="<?php echo esc_attr($value); ?>" style="background-image:url(<?php echo esc_url($attachment_image[0]);?>);background-size:cover;">
                    <i class="edit dashicons dashicons-plus-alt" title="<?php _e('Replace Image', ZOCORE_NAME); ?>"></i>
                    <i class="remove dashicons dashicons-dismiss" title="<?php _e('Remove Image', ZOCORE_NAME); ?>"></i>
                </li>
            <?php endif; endforeach; ?>
            <?php if($params['field'] != 'single'): ?>
                <li class="items" data-id=""><i class="add dashicons dashicons-plus-alt" title="<?php _e('Add Image', ZOCORE_NAME); ?>"></i></li>
    ...
    public function save_meta_boxes($post_id)
	{
		...
		if(!empty($zo_meta)){
		  update_post_meta($post_id, '_zo_meta_data', json_encode($zo_meta));
		}
	}
}