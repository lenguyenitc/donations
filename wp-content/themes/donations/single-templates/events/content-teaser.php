...
?>
<article id="post-<?php the_ID(); ?>" <?php post_class('event-teaser'); ?>>
    <div class="zo-event-left col-md-6 col-lg-6 col-sm-12 col-xs-12">
        <div class="zo-event-meta">
    ...
    <div class="zo-event-detail col-md-6 col-lg-6 col-sm-12 col-xs-12">
